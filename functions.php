...
add_filter('manage_brand_posts_columns', 'add_img_column');
add_filter('manage_brand_posts_custom_column', 'manage_img_column', 10, 2);
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
	jQuery(".wpcf7-form.sent").find('.contact-hide').hide();
}, false );
/* ]]> */
</script>
<?php
